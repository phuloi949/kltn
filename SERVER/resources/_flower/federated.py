...
# if hasattr(args, 'id_client'):
#     if args.id_client == "0":
#         trainloaders = split_trainloader(trainloaders, 0.5)
#         print("Client 0")
#         print("Length of trainloader: ",{len(trainloaders)})
#     else:
#         trainloaders = split_trainloader(valloaders, 0.5)
#         print("Client 1")
#         print("Length of trainloader: ",{len(trainloaders)})
trainloaders = split_trainloader(trainloaders, 0.5)
